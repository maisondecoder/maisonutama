<!-- Hero CTA -->
<div class="py-5 bg-searchbar" style="margin-top:-15px">
    <div class="p-3">
        <input type="text" class="form-control form-control-lg my-4" id="searchbar" aria-describedby="searchBar" placeholder="" style="max-width:800px; margin:auto">
    </div>

    <!-- Brands Logo -->
    <div class="container text-center mb-5">
        <img class="img-fluid" src="<?= $GLOBALS['domain_static'] . '/assets/logo-brands-homepage-putih.png'; ?>" width="700px" alt="Brand Partner Logo">
    </div>
    <!-- Brands Logo -->
</div>
<div id="hero" class="container p-4 pb-1 mb-5">
    <div class="row">
